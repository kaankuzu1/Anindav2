...
const inboxes_module_1 = require("./modules/inboxes/inboxes.module");
const campaigns_module_1 = require("./modules/campaigns/campaigns.module");
const leads_module_1 = require("./modules/leads/leads.module");
const warmup_module_1 = require("./modules/warmup/warmup.module");
...
let AppModule = (() => {
    let _classDecorators = [(0, common_1.Module)({
            imports: [
                ...
                inboxes_module_1.InboxesModule,
                campaigns_module_1.CampaignsModule,
                leads_module_1.LeadsModule,
                warmup_module_1.WarmupModule,
